...
namespace Voice2Action
{
    ...
    public class InteractableTarget : MonoBehaviour
    {
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable m_Interactable;
        ...
        private void Start()
        {
            m_Interactable = gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
