...
namespace Voice2Action
{
    ...
    public class SceneManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor m_LeftRayInteractor;
        
        /// <value>Right Hand controller Ray Interactor</value>
        [SerializeField]
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor m_RightRayInteractor;
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactables.IXRHoverInteractable m_Interactable;
        ...
        private void OnHoverEntered(HoverEnterEventArgs args)
        {
            ...
            if (m_Interactable is UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable)
            {
               SetShapeInfo(m_Interactable as UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable, true);
            }
        }
        ...
        { 
            ...
            if (m_Interactable is UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable)
            {
                SetShapeInfo(m_Interactable as UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable, false);
            }
        }
        ...
        private void SetShapeInfo(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable xrGrabInteractable, bool showPanel)
        {
            if (!showPanel)
            {
